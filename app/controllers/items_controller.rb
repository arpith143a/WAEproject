class ItemsController < ApplicationController
  ...
  # GET /items/1/edit
  def edit
    if @item.close_deal || @item.is_bidding_end?
      return redirect_to item_path(@item), flash: {error: 'This Item deal has already been closed, cannot edit details anymore'}
    end
    @item.type = params[:type]
  end
